 ...
 *  class construction.
*/
public class HintText extends JLabel implements FocusListener, DocumentListener {
	...
	private static final long serialVersionUID = -5093377113632699900L;
	...
	public HintText(String text, JTextComponent component) {
		
		this(text, component, Show.ALWAYS);
		
	}

	public HintText(String text, JTextComponent component, Show show) {
